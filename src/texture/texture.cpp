...
void Texture::loadTexture(const std::string& path, const std::string& name, unsigned int n, unsigned int& texture, Shader& shader) {
...
unsigned int* Texture::getTexturesID() { return textures; }
