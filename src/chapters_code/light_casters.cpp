...
int main() {
	...
	while(!glfwWindowShouldClose(window)) {
		...
		for (unsigned int i = 0; i < 10; i++) {	
			...
			cubeShaders.setVec3("light.ambient", glm::vec3(0.1f, 0.1f, 0.1f));
			cubeShaders.setVec3("light.diffuse", glm::vec3(0.8f, 0.8f, 0.8f));
			cubeShaders.setVec3("light.specular", glm::vec3(1.0f, 1.0f, 1.0f));	
			cubeShaders.setVec3("light.direction", glm::vec3(-0.2f, -1.0f, -0.3f));		
			cubeShaders.setFloat("light.constant", 1.0f);	
			cubeShaders.setFloat("light.linear", 0.09f);	
			cubeShaders.setFloat("light.quadratic", 0.032f);	
			cubeShaders.setVec3("light.position", sourcePos);	
			cubeShaders.setVec3("light.position",  camera->getPosition());
			cubeShaders.setVec3("light.direction", camera->getFront());
			cubeShaders.setFloat("light.cutOff",   glm::cos(glm::radians(12.5f)));
			cubeShaders.setFloat("light.outerCutOff",  glm::cos(glm::radians(17.5f)));
		...
		sourceTransform.setTranslate(sourcePos);
