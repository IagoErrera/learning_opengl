...
int main() {
	...
	while(!glfwWindowShouldClose(window)) {
		...
		// Update Lights	
		for (int i = 0; i < 4; i++) {
			std::string attr = "pointLights";
			attr.append("[");
			attr.append(std::to_string(i));
			attr.append("]");
			cubeShaders.setVec3(attr + ".position", pointLightPositions[i]);
			cubeShaders.setVec3(attr + ".ambient", glm::vec3(0.05f, 0.05f, 0.05f));
			cubeShaders.setVec3(attr + ".diffuse", glm::vec3(0.8f, 0.8f, 0.8f));
			cubeShaders.setVec3(attr + ".specular", glm::vec3(1.0f, 1.0f, 1.0f));	
			cubeShaders.setFloat(attr + ".constant", 1.0f);	
			cubeShaders.setFloat(attr + ".linear", 0.09f);	
			cubeShaders.setFloat(attr + ".quadratic", 0.032f);	
		}	
				
		cubeShaders.setVec3("directionalLight.direction", -0.2f, -1.0f, -0.3f);
		cubeShaders.setVec3("directionalLight.ambient", 0.05f, 0.05f, 0.05f);
		cubeShaders.setVec3("directionalLight.diffuse", 0.4f, 0.4f, 0.4f);
		cubeShaders.setVec3("directionalLight.specular", 0.5f, 0.5f, 0.5f);	

		cubeShaders.setVec3("flashLight.ambient", 0.0f, 0.0f, 0.0f);
		cubeShaders.setVec3("flashLight.diffuse", 1.0f, 1.0f, 1.0f);
		cubeShaders.setVec3("flashLight.specular", 1.0f, 1.0f, 1.0f);
		cubeShaders.setFloat("flashLight.constant", 1.0f);
		cubeShaders.setFloat("flashLight.linear", 0.09f);
		cubeShaders.setFloat("flashLight.quadratic", 0.032f);
		cubeShaders.setFloat("flashLight.cutOff", glm::cos(glm::radians(12.5f)));
		cubeShaders.setFloat("flashLight.outerCutOff",  glm::cos(glm::radians(15.0f)));
		cubeShaders.setVec3("flashLight.position", camera->getPosition());	
		cubeShaders.setVec3("flashLight.direction", camera->getFront());	
